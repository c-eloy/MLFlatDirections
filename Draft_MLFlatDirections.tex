...
As a first simplified example we have considered only the parameters $x_{1}, x_{2}, x_{4}, \tilde{x}_{8}$ and $x_{10}$. The potential~\eqref{eq:scalarpotential} becomes
