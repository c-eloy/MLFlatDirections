...
\section{Numerical analysis}
  ...
  \begin{enumerate}
	  ...
	  Averaged number of particles reproducing a target in a successful run: $931$

	  Mean loss with regularisation for particles reproducing a target: $597.0$

	  Mean loss without regularisation for particles reproducing a target: $345.0$
  		\item For 100 runs with parameters
		\begin{equation}
			\begin{gathered}
				\texttt{max degree} = 4, \quad \texttt{max num monomials} = 6, \quad n_{\rm iter} = 1000, \quad n_{\rm particles} = 1000, \\
	  ...
	  \begin{equation}
	  	...
	  	\end{tabular}
	  \end{equation}
	  Averaged number of particles reproducing a target in a successful run: $960$

	  Mean loss with regularisation for particles reproducing a target: $605.8$

	  Mean loss without regularisation for particles reproducing a target: $358.8$
	  \item For 100 runs with parameters
		\begin{equation}
			\begin{gathered}
				\texttt{max degree} = 4, \quad \texttt{max num monomials} = 6, \quad n_{\rm iter} = 1000, \quad n_{\rm particles} = 1000, \\
	  ...
	  \begin{equation}
	  	...
	  	\end{tabular}
	  \end{equation}
	  Averaged number of particles reproducing a target in a successful run: $973$

	  Mean loss with regularisation for particles reproducing a target: $854.2$

	  Mean loss without regularisation for particles reproducing a target: $602.5$
  \end{enumerate}
